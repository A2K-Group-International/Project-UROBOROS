...
import ConfigureGroup from "@/components/Ministry/ConfigureGroup";
...
import GroupAnnouncements from "@/components/Ministry/GroupAnnouncements";
import GroupMembers from "@/components/Ministry/GroupMembers";
import { getInitial } from "@/lib/utils";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import CartoonizedChurch from "@/assets/images/CartoonizedChurch.png";

import ConfigureSubgroup from "@/components/Ministry/ConfigureSubgroup";
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-primary-outline">
      ...
      >
        ...
        <div className="mr-3">
          <Avatar className="flex h-10 w-10 justify-center rounded-lg bg-primary">
            <AvatarImage
              className="h-10 w-10 rounded-lg object-cover"
              src={ministry.image_url}
              alt="profile picture"
            />
            <AvatarFallback className="h-10 w-10 rounded-lg bg-primary">
...
const Ministries = () => {
  ...
  const { ministries, ministryLoading } = useMinistry({ role: userData?.role });
  ...
  return (
    <div className="flex h-full flex-col text-primary-text lg:flex-row">
      <aside className="no-scrollbar w-full overflow-y-auto border-primary-outline/50 pb-3 lg:max-w-[25rem] lg:border-r">
