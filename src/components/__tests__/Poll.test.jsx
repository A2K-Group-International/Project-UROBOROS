...
describe("fetchPoll", () => {
  ...
  it("should fetch poll with dates, times, and answers successfully", async () => {
    ...
    answersChain.eq.mockReturnThis();
    answersChain.eq.mockResolvedValueOnce({ data: pollAnswers, error: null });
...
describe("fetchPollAnswers", () => {
  ...
  it("should fetch poll answers successfully", async () => {
    ...
    answersChain.eq.mockReturnThis();
    answersChain.eq.mockResolvedValue({ data: answers, error: null });
...
describe("fetchPollUserAnswers", () => {
  ...
  it("should fetch and process poll user answers successfully", async () => {
    ...
    answersChain.eq.mockReturnThis();
    answersChain.eq.mockResolvedValue({ data: pollUserAnswers, error: null });
