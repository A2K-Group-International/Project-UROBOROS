...
const EditReplyForm = ({
  ...
  const { updateReplyMutation } = useReply(comment_id, false, announcement_id);
  ...
  return (
    <>
      <form
        ...
        className="relative z-50 mb-2 flex w-full flex-col gap-2"
      >
        <Textarea
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button
              disabled={
                !getValues("comment")?.trim() || updateReplyMutation.isPending
              }
              type="submit"
              className="bg-accent"
            >
              {updateReplyMutation.isPending ? "Updating..." : "Update"}
            </Button>
          </div>
        </div>
      </form>
